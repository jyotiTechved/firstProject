...
public class TechnologyMobileApp {
...
WebDriver driver;
	...
	@FindBy(xpath="//span[.='Mobile App Development'][1]")
	...
	public void mobileApp() throws IOException, Exception {
		...
		UserActions.clickElement(mobileApp, "mobileApp", "mobileApp_c");
