...
WebDriver driver;
	...
	@FindBy(xpath="//div[@class='sub-menu-indiv']//a[@href='/conversion-rate-optimization/web-conversion-optimization']")
	public WebElement cro;
	...
	public void dataCRO() throws IOException, Exception {
		...
		UserActions.clickElement(cro, "CRO", "cro_c");
