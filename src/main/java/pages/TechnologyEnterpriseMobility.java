...
public class TechnologyEnterpriseMobility {
...
WebDriver driver;
	...
	@FindBy(xpath="//a[text()='Technology & Engineering']")
	public WebElement technology;
	
	@FindBy(xpath="//span[text()='Mobility Solutions']")
	public WebElement mobility;
	
	@FindBy(xpath="//a[@href='/enterprise-mobility-solutions.aspx'][1]")
	...
	public TechnologyEnterpriseMobility() {
	...
	public void enterpriseMobility() throws IOException, Exception {
		...
		UserActions.clickElement(technology, "technology", "technology_c");
		UserActions.clickElement(mobility, "mobility", "mobility_c");
		UserActions.clickElement(enterprise, "enterprise", "enterprise_c");
