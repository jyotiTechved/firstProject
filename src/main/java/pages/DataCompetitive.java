...
public class DataCompetitive {
	...
	@FindBy(xpath="//div[@class='sub-menu-indiv']//a[@href='/conversion-rate-optimization/competitor-analysis-in-web-space']")
	public WebElement competitive;
	...
	public void dataCompetitive() throws IOException, Exception {

		driver.get(Global.appURL);

		Global.dataMap = TestData.readTestData(Global.id, Global.className, Global.methodName);
		UserActions.clickElement(servicesTab, "Service TAB", "ServiceTab_C");
		UserActions.clickElement(data, "Data", "data_c");
		UserActions.clickElement(competitive, "competitive", "competitive_c");
